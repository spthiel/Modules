...
.addAction("countdown(<until>)","Creates a countdown to the specified datetime. Time has to be in format hh:mm:ss and Date has to be in format yyyy-MM-dd only one of both is required")
.addAction("coundup()","Creates a countup from the current time")
.addAction("counter(<id>)","Gives the current value of the countdown or countup with the id (value returned from the functions)")
.addAction("leftpad(<value>,[tofillup],[character])","Lefpads the value up to <tofill> (default 2) with the specified <character> (default 0)")
...
.addDownload(26,"./modules/nei/module_NotEnoughInformation-0.9.1-26.1-0.15.4-mc1.12.1.jar")

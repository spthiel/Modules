...
.addAction("[&result =] eval(<[#&]result>,<expression>)","Evaluates an expression with float values. Valid operations: +, -, *, x, /, :, (, ), pi, e, sqrt, sin, cos, tan, arcsin, arccos, arctan, ran, floor, cail, round, log")

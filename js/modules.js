...
.addAction("&object = jsonget(<json>,<key>)","Retuns the object of the key of the specified json. Key may contains a full path seperated by .")
...
.setDescription("Adds a auto reconnect functionality to minecraft.")
...
.addAction("return(<value>,[value 2,value 3...]","Sets the return value of the function and stops it. Use more than one parameter or return an array variable to return more than one information")
...
.addChangelog(26,"14/may/21", "0.3")
    ...
    .addLine("Fixed a bug with functions which don't contain arguments.")
    .build()

...
.addDownload(26, "./modules/nei/module_NotEnoughInformation-0.9.7.1-26.1-0.15.4-mc1.12.1.jar", "0.9.7.1")
.addDownload(26, "./modules/nei/module_NotEnoughInformation-0.9.8-26.1-0.15.4-mc1.12.1.jar", "0.9.8")
.addDownload(26, "./modules/nei/module_NotEnoughInformation-0.9.8.1-26.1-0.15.4-mc1.12.1.jar", "0.9.8.1")
.addDownload(26, "./modules/nei/module_NotEnoughInformation-0.9.8.1-26.1-0.15.4-mc1.12.1.jar", "0.9.8.2")
.addChangelog(26,"10/apr/20")
    .addLine("Fixed JSONException in jsonget")
    .build()
.addChangelog(26,"30/mar/20")
    .addLine("Fixed NPE in GetFishHook")
    .build()
.addChangelog(26,"19/mar/20")
    .addLine("Added GetFishHook")
    .build()
.addChangelog(26,"18/mar/20")
    .addLine("Birthday update")
    .addLine("Fixed GetMouseItem")
    .build()
.addChangelog(26,"14/mar/20")

...
.addAction("ifininv([mode],<...items>)","Checks whether a set amount of itemtypes is contained in the inventory. Type is 'any' by default and can be 'any', 'all', a number or a percentage")

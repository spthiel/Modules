...
.addAction("ELSEIFMATCHES(<subject>,<pattern>,[&target],[group])","The actions following this action will only be executed when the <subject> matches the <pattern>. Optionally the whole match (or only a group specified by [group]) can be saved into [&target].")
.addAction("ELSEIFCONTAINS(<haystack>,<needle>)","The actions following this action will only be executed when the <haystack> contains the <pattern>.")
.addAction("ELSEIFBEGINSWITH(<haystack>,<needle>)","The actions following this action will only be executed when the <haystack> begins with <pattern>.")
.addAction("ELSEIFENDSWITH(<haystack>,<needle>)","The actions following this action will only be executed when the <haystack> ends with <pattern>.")
...
.addDownload(26, "./modules/nei/module_Klacaiba-1.7.0-26.1-0.15.4-mc1.12.1.jar", "1.9.0")
.addChangelog(26,"21/jan/20", "1.9.0")
    .addLine("Added EHITX")
    .addLine("Added EHITY")
    .addLine("Added EHITZ")
    .addLine("Calcyaw now takes floats as values if desired (only in x,y,z mode)")
    .build()
.addChangelog(26,"06/jan/20", "1.7.0")
    ...
    .build()
.addChangelog(26,"06/jan/20", "1.6.0")

...
.addAction("PUSH(<array>,<...values>)","Appends value[s] to the end of array. Values may be constants, array[*] to copy an entire array or array[a-b] to copy a <= indexes < b to new array.")
.addAction("PUT(<array>,<...values>)","Inserts value[s] at the first empty point in array. Values may be constants, array[*] to copy an entire array or array[a-b] to copy a <= indexes < b to new array.")
...
.addDownload(26, "./modules/nei/module_Klacaiba-1.6.0-26.1-0.15.4-mc1.12.1.jar", "1.6.0")
.addChangelog(26,"30/dec/20", "1.6.0")
